...
\include{cap_operprop/cap_operprop} % \include{respostas}
%\setcounter{chapter}{1} 
\include{cap_expralg/cap_expralg} %\include{respostas}
%\setcounter{chapter}{2} 
\include{cap_conjuntos}
...
\include{cap_equacoes/cap_inequacoes}
%\setcounter{chapter}{6} 
\include{cap_equacoes/cap_modulo}
%\include{respostas}

% \setcounter{part}{2}
\part{Polinômios}
%\setcounter{chapter}{7} 
\include{cap_polinomios}
% \setcounter{chapter}{8} 
\include{cap_fracoesparciais}
...
\include{cap_funcao/cap_funcao2grau}
%\setcounter{chapter}{11} 
\include{cap_funcao/cap_funcaopartes}
%\include{respostas}
%\setcounter{chapter}{12} 
\include{cap_funcao/cap_funcaopotencia}
%\setcounter{chapter}{13} 
\include{cap_funcao/cap_funcaotransformacao}
% \include{respostas}

%\setcounter{part}{4}
\part{Funções reais II}
%\setcounter{chapter}{14}
\include{cap_explog/cap_injetora}
% \setcounter{chapter}{15} 
\include{cap_explog/cap_exp}
% \setcounter{chapter}{16} 
\include{cap_explog/cap_log}
